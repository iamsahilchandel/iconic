...
type TextBoxNodeProps = {
  id: string;
};

export function TextBoxNode({ id }: TextBoxNodeProps) {
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between px-4 pt-4">
          <div className="flex items-center space-x-3">
            ...
            <div className="font-medium text-sm text-white">Text Content</div>
          </div>
          <Button
            variant="ghost"
            size="icon"
        ...
        <p className="text-xs text-white/70 px-4">
          Enter text content to analyze and process
        </p>
